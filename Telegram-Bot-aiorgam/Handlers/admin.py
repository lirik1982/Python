...
async def make_changes_commend(message: types.Message):
    global ID
...
async def load_price(message: types.Message, state: FSMContext):
    if message.from_user.id == ID:
        ...
        await sql_lite.sql_add_command(state)
...
def register_handlers_admin(dp: Dispatcher):
    ...
    dp.register_message_handler(Text(equals="*", ignore_case=True), state="*")
    dp.register_message_handler(make_changes_commend, commands=['moderator'], is_chat_admin=True)
